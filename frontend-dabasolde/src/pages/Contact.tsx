    ...
    <div className="container contact-wrapper">
      <div className="contact-card">
        ...
        <div className="contact-actions">
          {/* WhatsApp Button */}
          <a href="https://wa.me/212600000000" target="_blank" rel="noreferrer" className="contact-btn wa-btn">
          ...
          {/* Email Button */}
          <a href="mailto:contact@dabasolde.com" className="contact-btn mail-btn">
             <span className="btn-icon">
               {/* Mail SVG Icon */}
